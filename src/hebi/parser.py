...
from hebi.utils.dots.manifest import Manifest
from hebi.utils.dots.source import DotsSource
from hebi.utils.io import warn
from hebi.utils.paths import wallpapers_dir
from hebi.utils.scheme import get_scheme_names, scheme_variants
from hebi.utils.wallpaper import get_wallpaper


def parse_args() -> tuple[argparse.ArgumentParser, argparse.Namespace]:
    parser = argparse.ArgumentParser(prog="hebi", description="Main control script for the Hebi dotfiles")
    ...
    emoji_parser.add_argument("-n", "--nerdfont", action="store_true", help="output nerdfont icons instead of emojis")
    ...
    install_parser = command_parser.add_parser(
        "install",
        help="install the Hebi dotfiles",
