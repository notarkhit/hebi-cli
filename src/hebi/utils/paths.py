...
c_config_dir: Path = config_dir / "hebi"
c_data_dir: Path = data_dir / "hebi"
c_state_dir: Path = state_dir / "hebi"
c_cache_dir: Path = cache_dir / "hebi"
...
config_backup_dir: Path = config_dir / ".bak"
...
screenshots_dir: Path = Path(os.getenv("HEBI_SCREENSHOTS_DIR", pictures_dir / "Screenshots"))
screenshots_cache_dir: Path = c_cache_dir / "screenshots"

recordings_dir: Path = Path(os.getenv("HEBI_RECORDINGS_DIR", videos_dir / "Recordings"))
